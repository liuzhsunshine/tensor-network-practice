...
Nstate = 10
#number of states kept during sweep
Nsweep = [10]
...
def finite_system_algorithm(L, m_warmup, m_sweep_list):
    ...
    for m in m_sweep_list: # states kept during truncation
        while True:
            ...
            print("E/L =", energy / L)
            print("error=", ExactEnergy - energy / L)

            # Save the block from this step to disk.
            block_disk[sys_label, sys_block.length] = sys_block

            # Check whether we just completed one full sweep.
...
if __name__ == "__main__":
    ...
    finite_system_algorithm(L=Nlength, m_warmup=Nstate, m_sweep_list=Nsweep)
